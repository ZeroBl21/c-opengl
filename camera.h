...
inline Camera create_camera(vec3s position, vec3s up, float yaw, float pitch) {
  Camera camera = {
      .Position = position,
...
inline Camera create_camerav(vec3s position) {
...
inline Camera create_camera_scalar(float posX, float posY, float posZ,
...
// systems)
inline void camera_process_keyboard(Camera *camera, CameraMovement direction,
                                    float deltaTime) {
...
inline void camera_process_mouse_movement(Camera *camera, float xoffset,
...
inline void camera_process_mouse_scroll(Camera *camera, float yoffset) {
